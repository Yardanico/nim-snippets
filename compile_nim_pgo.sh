...
mv default.profraw npeg.profraw
# Gather data from compiler compilation
./bin/nimpgo1 c -d:danger -o:temp compiler/nim.nim
mv default.profraw compiler.profraw
# Merge all 3 profiling files into one file
llvm-profdata merge arraymancer.profraw npeg.profraw compiler.profraw -output data.profdata
